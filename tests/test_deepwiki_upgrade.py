...
class BlueprintPromptTests(unittest.TestCase):
    def test_default_blueprint_preserves_deepwiki_memory(self):
        ...
        self.assertEqual(blueprint["repo_name"], "Torus")
        self.assertIn("src/contracts/src/Torus.sol", blueprint["scope_files"])
        self.assertIn("src/contracts/src/TorusBuyAndProcess.sol", blueprint["scope_files"])
    ...
    def test_question_generator_includes_blueprint_and_local_proof_language(self):
        ...
        self.assertIn("src/contracts/src/Torus.sol", prompt)
...
[
  ...
  "https://deepwiki.com/example/Torus--001",
  "https://deepwiki.com/example/Torus--002"
]
"""
